...
import VCA from "../testing-components/VCA.vue";
import RealApi from "../testing-components/RealApi.vue";
import Teaser from "@storyblok/vue-playground-vca/components/Teaser.vue";
import Grid from "@storyblok/vue-playground-vca/components/Grid.vue";
import Page from "@storyblok/vue-playground-vca/components/Page.vue";
import Feature from "@storyblok/vue-playground-vca/components/Feature.vue";
import { StoryblokVue, apiPlugin } from "@storyblok/vue-2";

const prepare = (pluginOpts = {}, comp = VCA, globalOpts = {}) => {
  mount(comp, {
    extensions: {
      plugins: [
        [
